 ...
 * 时间：2017/3/21 10:26
 */
public class Release_SupplyDemandActivity extends BaseActivity implements View.OnClickListener, ResultCallBack {
    private String id;
    ...
    public void initView() {
        ...
        editText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (s.length() >= 100) {
                    TextUtils.Toast(Release_SupplyDemandActivity.this, "输入的字符已达上限！");
                }
            }
