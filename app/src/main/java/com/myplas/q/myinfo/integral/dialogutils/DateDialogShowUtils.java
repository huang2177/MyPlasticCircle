...
import com.myplas.q.myinfo.integral.adapter.Integral_Date_Grid_Adapter;
import com.myplas.q.myinfo.integral.adapter.IntegralAdapter;
import com.myplas.q.myinfo.integral.datehelper.CalendarPickerView;
...
public class DateDialogShowUtils implements CalendarPickerView.OnDateSelectedListener, View.OnClickListener
    ...
    public void showDialog(Activity context, List<String> list_unclickable, Date date_start, Date date_end) {
        try {
            ...
            dateGridAdapter = new Integral_Date_Grid_Adapter(context, list);
