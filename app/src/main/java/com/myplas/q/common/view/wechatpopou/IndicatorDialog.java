...
import static com.myplas.q.common.view.wechatpopou.IndicatorBuilder.BOTTOM;
import static com.myplas.q.common.view.wechatpopou.IndicatorBuilder.LEFT;
import static com.myplas.q.common.view.wechatpopou.IndicatorBuilder.RIGHT;
import static com.myplas.q.common.view.wechatpopou.IndicatorBuilder.TOP;
...
public class IndicatorDialog {
    ...
    private void addRecyclerView2Layout() {
        childLayout = (LinearLayout) LayoutInflater.from(mContext).inflate(R.layout.popou_wechat_layout, rootLayout, true);
