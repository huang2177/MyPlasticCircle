...
public class HorizontalStepsViewIndicator extends View {
    ...
    private int defaultStepIndicatorNum = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 80, getResources().getDisplayMetrics());
    ...
    private int mUnCompletedLineColor = ContextCompat.getColor(getContext(), R.color.color_gray);//定义默认未完成线的颜色  definition
    private int mCompletedLineColor = ContextCompat.getColor(getContext(), R.color.color_red);//定义默认已完成线的颜色
    ...
    private void init() {
        ...
        mCompletedLineHeight = 0.02f * defaultStepIndicatorNum;
