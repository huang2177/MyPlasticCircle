...
/**
 * Created by 黄双 on 2017/11/13 0013.
 */
...
public class BaiduProgressBar extends View {
     ...
     * 交换执行动画的颜色数组
     */
    private int[] colors = new int[]{getResources().getColor(R.color.color_dl_integral_confirm),
    ...
    public BaiduProgressBar(@NonNull Context context) {
        super(context);
        startAnimator();
    }

    public BaiduProgressBar(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        startAnimator();
    }

    public BaiduProgressBar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
