...
public class MarqueeView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        ...
        mTextColor = a.getColor(R.styleable.MarqueeView_mvTextcolor, Color.RED);
        mTextSize = a.getDimension(R.styleable.MarqueeView_mvTextSize, 48);
        mIsRepeat = a.getBoolean(R.styleable.MarqueeView_mvIsRepeat, false);
        mStartPoint = a.getInt(R.styleable.MarqueeView_mvStartPoint, 0);
        mDirection = a.getInt(R.styleable.MarqueeView_mvDirection, 0);
        mSpeed = a.getInt(R.styleable.MarqueeView_mvSpeed, 20);
        a.recycle();
